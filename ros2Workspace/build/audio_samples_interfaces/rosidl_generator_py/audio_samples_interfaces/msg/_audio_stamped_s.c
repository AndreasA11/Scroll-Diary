...
bool audio_samples_interfaces__msg__audio_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("audio_samples_interfaces.msg._audio_stamped.AudioStamped", full_classname_dest, 56) == 0);
  }
  audio_samples_interfaces__msg__AudioStamped * ros_message = _ros_message;
  {  // data
...
PyObject * audio_samples_interfaces__msg__audio_stamped__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("audio_samples_interfaces.msg._audio_stamped");
