...
#include "audio_samples_interfaces/msg/detail/audio_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = audio_samples_interfaces::msg::AudioStamped;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const audio_samples_interfaces::msg::AudioStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<audio_samples_interfaces::msg::AudioStamped *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_audio_samples_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<audio_samples_interfaces::msg::AudioStamped>()
{
  return &audio_samples_interfaces::msg::typesupport_fastrtps_cpp::_AudioStamped__handle;
}
