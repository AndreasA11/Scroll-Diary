...
#include "audio_samples_interfaces/msg/detail/audio_stamped__rosidl_typesupport_fastrtps_c.h"
...
using _AudioStamped__ros_msg_type = audio_samples_interfaces__msg__AudioStamped;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = audio_samples_interfaces__msg__AudioStamped;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const audio_samples_interfaces__msg__AudioStamped * ros_message = static_cast<const audio_samples_interfaces__msg__AudioStamped *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_audio_samples_interfaces__msg__AudioStamped(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  audio_samples_interfaces__msg__AudioStamped * ros_message = static_cast<audio_samples_interfaces__msg__AudioStamped *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_audio_samples_interfaces__msg__AudioStamped(cdr, ros_message);
}

static uint32_t _AudioStamped__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_audio_samples_interfaces__msg__AudioStamped(
...
static size_t _AudioStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_audio_samples_interfaces__msg__AudioStamped(
