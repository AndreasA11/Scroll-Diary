...
class Metaclass_AudioStamped(type):
    """Metaclass of message 'AudioStamped'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('speech_to_text_interfaces')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'speech_to_text_interfaces.msg.AudioStamped')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__audio_stamped
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__audio_stamped
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__audio_stamped
            cls._TYPE_SUPPORT = module.type_support_msg__msg__audio_stamped
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__audio_stamped
...
class AudioStamped(metaclass=Metaclass_AudioStamped):
    """Message class 'AudioStamped'."""
