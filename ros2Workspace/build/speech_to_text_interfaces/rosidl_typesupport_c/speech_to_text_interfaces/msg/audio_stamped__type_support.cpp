...
static const _AudioStamped_type_support_symbol_names_t _AudioStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, speech_to_text_interfaces, msg, AudioStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, speech_to_text_interfaces, msg, AudioStamped)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, speech_to_text_interfaces, msg, AudioStamped)() {
  return &::speech_to_text_interfaces::msg::rosidl_typesupport_c::AudioStamped_message_type_support_handle;
}
