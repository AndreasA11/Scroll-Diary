...
bool AudioCaptureNode::loadWAV16kMonoF32(const char* filename, std::vector<float> &samples) {
...
bool AudioCaptureNode::startLiveCapture(LiveCapture &capture, ma_uint32 deviceIndex) {
...
void AudioCaptureNode::stopLiveCapture(LiveCapture &capture) {
