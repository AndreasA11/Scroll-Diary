...
bool speech_to_text_interfaces__msg__audio_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("speech_to_text_interfaces.msg._audio_stamped.AudioStamped", full_classname_dest, 57) == 0);
  }
  speech_to_text_interfaces__msg__AudioStamped * ros_message = _ros_message;
  {  // data
...
{
  /* NOTE(esteve): Call constructor of AudioStamped */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("speech_to_text_interfaces.msg._audio_stamped");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AudioStamped");
