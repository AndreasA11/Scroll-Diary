...
static const _AudioStamped_type_support_symbol_names_t _AudioStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, speech_to_text_interfaces, msg, AudioStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, speech_to_text_interfaces, msg, AudioStamped)),
  }
};
...
{
  return &::speech_to_text_interfaces::msg::rosidl_typesupport_cpp::AudioStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, speech_to_text_interfaces, msg, AudioStamped)() {
  return get_message_type_support_handle<speech_to_text_interfaces::msg::AudioStamped>();
}
